...
// complement: true = le plat a des accompagnements au choix
// prix2: deuxième taille disponible
export const PLATS = [
  ...
  { id: 5,  categorie: 'plats', nom: 'Sauce d\'arachide viande',      prix: 20, prix2: null, complement: true  },
  { id: 6,  categorie: 'plats', nom: 'Sauce d\'arachide poisson fumé',prix: 15, prix2: null, complement: true  },

  // Poissons
  { id: 7,  categorie: 'plats', nom: 'Bongo Poisson',                 prix: 20, prix2: null, complement: true  },
  { id: 8,  categorie: 'plats', nom: 'Maquereaux',                    prix: 20, prix2: null, complement: true  },
  { id: 9,  categorie: 'plats', nom: 'Sole',                          prix: 50, prix2: 60,   complement: true  },
  { id: 10, categorie: 'plats', nom: 'Bar / Capitaine',               prix: 25, prix2: 30,   complement: true  },
  { id: 11, categorie: 'plats', nom: 'Tilapia',                       prix: 15, prix2: 20,   complement: true  },
  { id: 12, categorie: 'plats', nom: 'Okok Bobolo',                   prix: 20, prix2: null, complement: false },
  { id: 13, categorie: 'plats', nom: 'Atieke Poisson',                prix: 20, prix2: 25,   complement: true  },
  { id: 14, categorie: 'plats', nom: 'Ndolé poisson fumé',            prix: 20, prix2: null, complement: true  },
  { id: 15, categorie: 'plats', nom: 'Ndolé Royal',                   prix: 25, prix2: null, complement: true  },

  // Viandes
  { id: 16, categorie: 'plats', nom: 'Kondre Viande',                 prix: 20, prix2: null, complement: true  },
  { id: 17, categorie: 'plats', nom: 'Tendons',                       prix: 15, prix2: null, complement: true  },
  { id: 18, categorie: 'plats', nom: 'Porc Tapé',                     prix: 7,  prix2: 13,   complement: false },
  { id: 19, categorie: 'plats', nom: 'Porc Tapé avec Aloco',          prix: 13, prix2: null, complement: false },
  { id: 20, categorie: 'plats', nom: 'Plat de Porc',                  prix: 15, prix2: null, complement: true  },
  { id: 21, categorie: 'plats', nom: 'Ailes de poulets',              prix: 7,  prix2: 13,   complement: true  },
  { id: 22, categorie: 'plats', nom: 'Poulet DG 1/2 plat',           prix: 30, prix2: null, complement: true  },
  { id: 23, categorie: 'plats', nom: 'Poulet entier',                 prix: 50, prix2: null, complement: true  },
  { id: 24, categorie: 'plats', nom: 'CORNTCHAP Viande',              prix: 20, prix2: null, complement: true  },

  // Brochettes
  { id: 25, categorie: 'plats', nom: 'Brochettes simple',             prix: 10, prix2: null, complement: false },
  { id: 26, categorie: 'plats', nom: 'Brochettes avec complément',    prix: 15, prix2: null, complement: true  },

  // Légumes & autres
  { id: 27, categorie: 'plats', nom: 'Taro Royal',                    prix: 25, prix2: null, complement: true  },
  { id: 28, categorie: 'plats', nom: 'Taro simple',                   prix: 20, prix2: null, complement: true  },
  { id: 29, categorie: 'plats', nom: 'ERU',                           prix: 20, prix2: null, complement: true  },
  { id: 30, categorie: 'plats', nom: 'Légume sauté plantain',         prix: 20, prix2: null, complement: true  },
  { id: 31, categorie: 'plats', nom: 'Légume Sauce poisson bar',      prix: 25, prix2: null, complement: true  },
  { id: 32, categorie: 'plats', nom: 'Pepe soupe',                    prix: 15, prix2: 20,   complement: false },
  { id: 33, categorie: 'plats', nom: 'Beignet haricots',              prix: 15, prix2: null, complement: false },
  { id: 34, categorie: 'plats', nom: 'Riz Sauce tomate Viande',       prix: 15, prix2: null, complement: false },
  { id: 35, categorie: 'plats', nom: 'Riz sauce tomate poisson',      prix: 20, prix2: null, complement: false },
  ...
  { id: 50, categorie: 'bieres', nom: 'Desperados petit',prix: 12, prix2: null },
  { id: 51, categorie: 'bieres', nom: 'Desperados grand',prix: 10, prix2: null },
  { id: 52, categorie: 'bieres', nom: 'Leffe grand',     prix: 10, prix2: null },
  ...
  { id: 71, categorie: 'sodas', nom: 'Coca-Cola',      prix: 3, prix2: 5    },
  ...
  { id: 77, categorie: 'sodas', nom: 'Eau minérale',   prix: 2, prix2: 3    },
  ...
  { id: 85, categorie: 'champagnes', nom: 'Clément d\'alsace', prix: 60,  prix2: null },
  { id: 86, categorie: 'champagnes', nom: 'Laurent Perrier',   prix: 60,  prix2: null },
  { id: 87, categorie: 'champagnes', nom: 'Moët',              prix: 100, prix2: null },

  // ─── WHISKYS ─────────────────────────────────────────────────────
  { id: 90, categorie: 'whiskys', nom: 'Baileys',          prix: 50,  prix2: null },
  ...
  // ─── FORMULES ────────────────────────────────────────────────────
  { id: 100, categorie: 'formules', nom: 'Formule 3 bières (Heineken / Desperados)', prix: 12, prix2: null },
]

// ─── COMPLÉMENTS ─────────────────────────────────────────────────
// Accompagnements inclus dans le prix du plat
export const COMPLEMENTS = [
  ...
  { id: 9,  nom: 'Frites',        prix_supplement: 0 },
  // Suppléments payants
  { id: 10, nom: 'Complément simple (+3€)', prix_supplement: 3 },
  { id: 11, nom: 'Complément maxi (+5€)',   prix_supplement: 5 },
]
